#!/usr/bin/env python3
# source: https://github.com/cornellius-gp/gpytorch/blob/v1.1.1/gpytorch/utils/toeplitz.py


import torch

from ziggy.misc import gpt_broadcasting as broadcasting
from ziggy.misc import gpt_fft as fft
